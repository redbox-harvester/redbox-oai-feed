...
environments {
	test {
		client {
			...
			inboundAdapter = "jmsIn" // the name of the main SI Endpoint the framework will ".stop()"
		}
		file {
		...
		velocityTransformer {
			...
			"record_eac-cpf" {
				...
				scripts {
					preVelocity = [["src/main/resources/deploy-manager/scripts/velocityTransformer-stringUtils.groovy":""]]
				}
			}
			record_oai_dc {
